...
function purchase1(){
    if(clicks>=(price1-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price1) + " clicks to purchase this upgrade."
    }
}
...
function purchase2(){
    if(clicks>=(price2-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price2) + " clicks to purchase this upgrade."
    }
}
...
function purchase3(){
    if(clicks>=(price3-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price3) + " clicks to purchase this upgrade."
    }
}
...
function purchase4(){
    if(clicks>=(price4-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price4) + " clicks to purchase this upgrade."
    }
}
...
function purchase5(){
    if(clicks>=(price5-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price5) + " clicks to purchase this upgrade."
    }
}
...
function purchase6(){
    if(clicks>=(price6-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price6) + " clicks to purchase this upgrade."
    }
}
...
function purchase7(){
    if(clicks>=(price7-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price7) + " clicks to purchase this upgrade."
    }
}
...
function purchase8(){
    if(clicks>=(price8-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price8) + " clicks to purchase this upgrade."
    }
}
...
function purchase9(){
    if(clicks>=(price9-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price9) + " clicks to purchase this upgrade."
    }
}
...
function purchase10(){
    if(clicks>=(price10-1)){
        ...
        document.getElementById("Text").textContent = "You must have " + new Intl.NumberFormat("en-US").format(price10) + " clicks to purchase this upgrade."
    }
}
